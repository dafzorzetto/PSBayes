...
start.time <- Sys.time()
#model_1=Gibbs_model(c=1, sim=scenario_1)
#model_1=lapply(1:samples, function(i) Gibbs_model(c=i, sim=scenario_1))
model_1=mclapply(1:samples, Gibbs_model, sim=scenario_1, mc.cores = 5)
end.time <- Sys.time()
time.taken <- end.time - start.time
time.taken

start.time <- Sys.time()
#model_2=Gibbs_model(c=1, sim=scenario_2)
model_2=mclapply(1:samples, Gibbs_model, sim=scenario_2, mc.cores = 5)
end.time <- Sys.time()
time.taken <- end.time - start.time
time.taken

start.time <- Sys.time()
model_3=mclapply(1:samples, Gibbs_model, sim=scenario_3, mc.cores = 5)
end.time <- Sys.time()
time.taken <- end.time - start.time
time.taken

start.time <- Sys.time()
model_4=mclapply(1:samples, Gibbs_model, sim=scenario_4, mc.cores = 5)
end.time <- Sys.time()
time.taken <- end.time - start.time
time.taken

start.time <- Sys.time()
model_5=mclapply(1:samples, Gibbs_model, sim=scenario_5, mc.cores = 5)
end.time <- Sys.time()
time.taken <- end.time - start.time
time.taken

save.image("results_shared_atoms.RData")
